...
<img src="../assets/02-cuda-ops/fig-01.png" alt="fig-01" width="70%" />
...
<img src="../assets/02-cuda-ops/fig-02.png" alt="fig-02" width="60%" />
...
假设<img src="../assets/02-cuda-ops/fig-03.png" alt="fig-03" width="35%" />
...
- Naive Matmul
  ...
  <img src="../assets/02-cuda-ops/fig-04.png" alt="fig-04" width="35%" />
...
- Tiled Matmul
  ...
  <img src="../assets/02-cuda-ops/fig-05.png" alt="fig-05" width="35%" />
...
- 基础idea：每个block处理一个列！然后在kernel内部就是对这个element进行一维的reduce啦
  ...
  <img src="../assets/02-cuda-ops/fig-06.png" alt="fig-06" width="30%" />
...
<img src="../assets/02-cuda-ops/fig-07.png" alt="fig-07" width="30%" />
...
- Step3：elementwise process -> Norm (aX + b, epsilon)
  ...
  <img src="../assets/02-cuda-ops/fig-10.png" alt="fig-10" width="50%" />
