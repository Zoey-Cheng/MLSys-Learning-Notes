---
title: "03-VLM：从 ViT/CLIP 到 Qwen-VL / DeepSeek"
---

# 03-VLM：从 ViT/CLIP 到 Qwen-VL / DeepSeek
...
按 doc 顺序写三段可跑代码（MiniVLM / Qwen2-VL / DeepEncoder），并和 HF 对齐：完整 notebook [09_mini_vlm.ipynb](../code/09_mini_vlm.ipynb)。
