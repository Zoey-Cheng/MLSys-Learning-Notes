...
|  | [04-Diffusion 详解(上) - 从 VAE 到 DDPM / DDIM](01_模型基础/01_04_Diffusion基础.md) | *WIP* | [ipynb](https://github.com/Zoey-Cheng/MLSys-Learning-Notes/blob/main/code/07_basic_ddim.ipynb) ｜ [colab](https://drive.google.com/file/d/1R8kfN8Qv2SQFy7XefKuEW2lebmiElTbP/view?usp=sharing) | Basic DDIM (MNIST) |
...
- **06/20/2026**: 模型基础 → 04-Diffusion 详解(上) [[link]](01_模型基础/01_04_Diffusion基础.md)，网页版发布（知乎待补）
