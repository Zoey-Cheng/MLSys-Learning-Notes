...
- 面试手写题 Quick Ref ([模型](notes/07_面试手写题/07_01_模型.md) / [推理](notes/07_面试手写题/07_02_推理.md) / [算子](notes/07_面试手写题/07_03_算子CUDA.md))
...
| 训练策略 | [01-分布式训练(0) - 背景知识(通信 & 单卡计算流)](notes/02_训练策略/02_01_分布式训练基础.md) | [link](https://zhuanlan.zhihu.com/p/1897578451143221835) | [ipynb](code/03-distributed-demo.ipynb) ｜ [colab](https://drive.google.com/file/d/15V25khFs8M8Ui3LW-_zDXUkquQytvBgq/view?usp=drive_link) | 通信原语 + DDP demo |
|  | 02-数据并行 DP *WIP* | | | |
...
| RL | *coming soon* | | | |
| 推理优化 | [01-推理基础](notes/05_推理优化/05_01_推理基础.md) | | [ipynb](code/08_mini_inference.ipynb) ｜ [colab](https://drive.google.com/file/d/1Zlicq3BShtFv4iWECkbHSqJ2iNZT42xW/view?usp=sharing) | mini inference |
...
- **06/21/2026**: 推理优化 → 01-推理基础 [[link]](notes/05_推理优化/05_01_推理基础.md)，网页版发布
...
- **04/20/2025**: 训练策略 → 01-分布式训练(0)-背景知识(通信 & 单卡计算流)，发布在知乎
