...
|  | [04-Diffusion 详解(上) - 从 VAE 到 DDPM / DDIM](notes/01_模型基础/01_04_Diffusion基础.md) | [link](https://zhuanlan.zhihu.com/p/2051913285751005547) | [ipynb](code/07_basic_ddim.ipynb) ｜ [colab](https://drive.google.com/file/d/1R8kfN8Qv2SQFy7XefKuEW2lebmiElTbP/view?usp=sharing) | Basic DDIM |
...
- **06/20/2026**: 模型基础 → 04-Diffusion 详解(上) [[link]](notes/01_模型基础/01_04_Diffusion基础.md)，网页版和知乎同步发布
