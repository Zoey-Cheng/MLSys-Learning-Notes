...
|  | [03-VLM (Qwen2-VL / DeepSeek-OCR 为例)](notes/01_模型基础/01_03_VLM.md) | [link](https://zhuanlan.zhihu.com/p/2054938508905690163) | [ipynb](code/09_mini_vlm.ipynb) ｜ [colab](https://drive.google.com/file/d/1XvnV8GDKcBRJ7viE3p9bfzrMWbXcDuwV/view?usp=sharing) | mini VLM / Qwen2-VL |
...
|  | [05-Diffusion(下) - Latent Diffusion 到 DiT / FLUX](notes/01_模型基础/01_05_Diffusion进阶.md) | | [ipynb](code/10_mini_sd_flux.ipynb) ｜ [colab](https://drive.google.com/file/d/1f3LFn-5BRBN_ED6DBPwcMd81wxUtSf-G/view?usp=sharing) | Mini SD / FLUX |
...
- **07/12/2026**: 模型基础 → 05-Diffusion(下) [[link]](notes/01_模型基础/01_05_Diffusion进阶.md)，网页版发布
